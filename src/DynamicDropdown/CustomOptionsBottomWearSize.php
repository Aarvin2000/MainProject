 ...
 */
class CustomOptionsBottomWearSize implements SelectOptionsProviderInterface
{
 ...
 {
 $items = new DataObject\BottomWearSize\Listing();
 $items->setOrderKey("Size");
 $items->setOrder('asc');
 $arr=[];
 
foreach ($items as $item) {
 array_push($arr,["value"=>$item->getSize(),"key"=>$item->getSize()]);
}
